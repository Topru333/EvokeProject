...
## Database
Open in visual studio solution explorer (обозреватель серверов). Click 'Connect to database'. Choice 'microsoft sql server file' and file  'Company.mdf' in App_Data.
Click connect.
